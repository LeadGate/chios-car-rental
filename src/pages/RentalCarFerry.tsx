  ...
  return (
    <Layout>
      ...
      >
        ...
        />
        <CompanyCard><p><strong>Supporting datapoint:</strong> The Ertürk figure comes straight from the operator's published tariff sheet, so treat it as firm. The Piraeus car figure of ~€81.50 is <em>derived</em> — a live Ferryhopper search on <strong>3 August 2026</strong> for two adults plus one car returned €159.50 with the adult fare at €39, so the car component is an approximation rather than a quoted car-only tariff. For Lesvos, Psara and Oinousses <strong>no operator publishes a standalone car tariff online</strong>; the ranges shown come from ferry-booking aggregators (Ferryhopper, Direct Ferries, Ferryscanner) and the local Psara operator's price list, so treat them as ranges to budget against rather than quotes to rely on.</p></CompanyCard>
