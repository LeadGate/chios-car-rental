  ...
  const faqSchema =
  {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Law 5209/2025 sets the built-up-area default speed limit at 30 km/h (in force since 1 January 2026), which affects built-up areas in Chios Town, Kampos district, Vrontados, and other settlement streets; 50 km/h still applies on roads with two or more marked lanes per direction or a central divider. The Hellenic Police (EL.AS) can enforce it with roadside checks and automated camera processing. On a Chios rental itinerary, that means extra caution near schools, village entrances, and narrow streets."
        }
      },
      {
        "@type": "Question",
