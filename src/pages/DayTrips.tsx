  ...
  return (
    <Layout>
      ...
      >
          ...
          <p className="text-gray-700 mb-4 leading-relaxed">The cross-border day trip works best on foot rather than by car. The classic version runs from the next island south: this guide to the <a href="https://car-rental-samos.com/samos-to-ephesus-day-trip/" target="_blank" rel="noopener noreferrer" className="text-primary underline hover:text-accent">Samos to Ephesus ferry day trip</a> explains how you leave the rental on the island and cross to Kuşadası as a foot passenger.</p>
      </Section>
