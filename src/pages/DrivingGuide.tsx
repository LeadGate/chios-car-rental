  ...
  return (
    <Layout>
      ...
      <Section
        ...
        alt
      >
          <CompanyCard><p><strong>Direct answer:</strong> The current rule for Chios is a <strong>30 km/h</strong> default speed limit in built-up areas under <strong>Law 5209/2025</strong>, in force since <strong>1 January 2026</strong>; 50 km/h applies only on multi-lane or divided urban roads. The <strong>Hellenic Police (EL.AS.)</strong> enforce this rule, and it replaces the older habit of assuming 50 km/h everywhere in town.</p></CompanyCard>
          <CompanyCard><p><strong>Supporting datapoint:</strong> The current framework sets <strong>30 km/h as the built-up-area default</strong>, <strong>50 km/h only on urban roads with two or more marked lanes per direction or a central divider</strong>, <strong>90 km/h on ordinary roads outside built-up areas</strong>, <strong>110 km/h on expressways</strong>, and <strong>130 km/h on motorways</strong>. Chios has no motorway network, but the rule matters if you leave the island by ferry and continue driving on the mainland.</p></CompanyCard>
      ...
      >
          ...
          <DataTable headers={["Violation", "Base Fine", "Repeat within 5 Years"]} rows={[["Mobile phone use without hands-free", "\u20ac350 + 30-day licence & registration withdrawal", "Up to \u20ac2,000 + 1-year licence withdrawal (3rd offence in 5 years)"], ["Running a red light", "\u20ac700 + 60-day licence withdrawal", "\u2014"], ["Running a STOP sign", "\u20ac350 + 30-day licence & registration withdrawal (\u20ac700 + 60 days if it causes a crash)", "\u2014"], ["Seatbelt or child restraint omission", "\u20ac350 + 30-day licence withdrawal (driver/child seat); \u20ac150 (passenger)", "Higher cumulative exposure"], ["Illegal overtaking on a solid line", "\u20ac700 + 30-day licence withdrawal", "Higher cumulative exposure"], ["DUI (0.50\u20130.80 g/L BAC)", "\u20ac350 + 30-day licence & registration withdrawal", "Higher BAC bands: \u20ac700 + 90 days (0.80\u20131.10 g/L); \u20ac1,200 + 180 days + imprisonment (>1.10 g/L)"], ["Speeding up to 20 km/h over limit", "\u20ac150 (no licence withdrawal)", "\u2014"], ["Speeding 21\u201330 km/h over limit", "\u20ac150 + 20-day licence withdrawal", "\u2014"], ["Speeding over 30 km/h above limit", "\u20ac350 + 30-day licence & registration withdrawal", "\u2014"]]} />
      ...
      >
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">What is the default speed limit in Chios towns and villages?</h3>
          <CompanyCard><p><strong>Direct answer:</strong> The default speed limit in built-up areas of Chios is <strong>30 km/h</strong> under <strong>Law 5209/2025</strong>, in force since <strong>1 January 2026</strong>; 50 km/h applies only on multi-lane or divided roads. The <strong>Hellenic Police (EL.AS.)</strong> enforce this limit in towns and village streets.</p></CompanyCard>
