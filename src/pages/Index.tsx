  ...
  return (
    <Layout>
      ...
      <HeroSection
        ...
        subtitle={<><p className="text-white drop-shadow-md">A live 7 July 2026 check found 11 offers for Chios from €92.84/day for an Opel Corsa, median €108.54/day — mid-summer island supply is tight and prices sit well above the €22/day shoulder-season rate, so book weeks ahead. Renting a car in Chios is still the most practical way to reach the island’s beaches, mountain villages, and monasteries because public buses are limited outside Chios Town. A pre-booked vehicle at Chios Airport helps you avoid queue time, compare CDW and SCDW options before arrival, and start driving immediately after landing at JKH (ICAO: LGHI), also called "Omiros" Airport.</p></>}
        image="/1.webp"
      ...
      >
          <p className="text-gray-700 mb-4 leading-relaxed">Chios car rental prices vary by season, transmission, and insurance bundle, and the most useful comparison is a rate with CDW included versus a rate with full coverage or zero excess. In 2026, economy cars in Chios often start near €22/day in shoulder months and rise sharply in peak summer — a live 7 July 2026 availability pull showed 11 offers from €92.84/day for an Opel Corsa, median €108.54/day, with local suppliers such as SMART Rent A Car, Aegean Atsalis, Kampas Rent A Car, and Masticars quoting higher when availability tightens.</p>
